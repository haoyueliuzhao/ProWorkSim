...
日期：2026-09-26，v0.15 选型与真实来源路线修订。以用户提供的[数据需求增强版理论稿](../reference/id-vtdo-v1-data-design.md)为完整设计依据，以[v0.14审计及模型建议](../reference/learning-audit-v014-model-selection.md)和[当前实验计划](../learning-v015-plan.md)规定本轮优先级。本文是该设计与仓库实现、实验门槛之间的正式对应；不把设计稿中的数量算例写成已建数据或运行结果。原ProWorkSim版本报告保留为历史证据。
